...
(function ($) {
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton = '<div class="jqyc" ><div class="jqyc-year-chooser border-top border-bottom row align-items-center" data-current-year="' + year + '">' +
            ...
            '<div class="jqyc-month text-center my-2 jqyc-jan" data-month="1" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center my-2 jqyc-feb" data-month="2" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center my-2 jqyc-mar" data-month="3" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center my-2 jqyc-apr" data-month="4" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-may" data-month="5" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-jun" data-month="6" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-jul" data-month="7" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-aug" data-month="8" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-sep" data-month="9" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-oct" data-month="10" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-nov" data-month="11" data-year="' + year + '"></div>' +
            '<div class="jqyc-month text-center  my-2 jqyc-dec" data-month="12" data-year="' + year + '"></div>' +
            '</div></div>';
        if (startFromSunday) {
        ...
        if (settings.colsSm != 12) {
            $this.find('.jqyc-months').addClass('row');
            $this.find('.jqyc-month').addClass('col-' + settings.colsSm)
        }
*/
        if (settings.colsMd != 12) {
            $this.find('.jqyc-months').addClass('row');
            $this.find('.jqyc-month').addClass('col-' + settings.colsMd)
        }
/*
        if (settings.colsLg != 12) {
            $this.find('.jqyc-months').addClass('row');
            $this.find('.jqyc-month').addClass('col-' + settings.colsLg)
        }
        ...
        if (settings.colsXl != 12) {
            $this.find('.jqyc-months').addClass('row');
            $this.find('.jqyc-month').addClass('col-' + settings.colsXl)
        }*/
